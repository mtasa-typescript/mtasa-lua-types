 ...
 * @noSelf
 */
export declare function setWaterDrawnLast(bEnabled: boolean): boolean;
 ...
 * @noSelf
 */
export declare function setWaterLevel(theWater: Water, level: number): boolean;

/**
 * @see https://wiki.multitheftauto.com/wiki/SetWaterLevel
 * @noSelf
 */
export declare function setWaterLevel(level: number): boolean;
 ...
 * @noSelf
 */
export declare function setWaveHeight(height: number): boolean;
