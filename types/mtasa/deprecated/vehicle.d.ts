declare function setVehicleColor(
    theVehicle: Vehicle,
    r1: number,
    g1: number,
    b1: number,
...
declare function setVehicleRespawnPosition(
    theVehicle: Vehicle,
    x: number,
    y: number,
    z: number,
...
declare function setVehicleWheelStates(
    theVehicle: Vehicle,
    frontLeft: number,
    rearLeft?: -1,
    frontRight?: -1,
...
declare function addVehicleSirens(
    theVehicle: Vehicle,
    sirenCount: number,
    sirenType: number,
...
declare function setVehicleSirens(
    theVehicle: Vehicle,
