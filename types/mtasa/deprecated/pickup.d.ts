/**
 * @description This function creates a pickup element, which is placed in the GTA world and can be picked
 * up to retrieve a health, armour or a weapon.
 * amount: This is an integer representing the amount of Health points or Armour points a pickup has.
 * weapon: If the type is a Weapon pickup, then it represents the weapon ID of the weapon pickup. When used
 * with the weapon pickup type set, the ammo parameter can be used.
 * model: If the pickup is a custom model, this is the model id to use. Many non-pickup models can be used,
 * though some may cause crashes. The following is a list of models designed to be used as pickups.
 ...
 * @param theType This is an integer representing the type of pickup, representing the
 * following types: **0: Health Pickup**, **1: Armour Pickup**, **2: Weapon Pickup**, **3: Custom Pickup**
