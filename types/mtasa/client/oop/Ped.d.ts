...
export class Ped extends Element {
     ...
     */
    getBonePosition(): LuaMultiReturn<[
        number,
        number,
        number
    ]>;
     ...
     */
    setCanBeKnockedOffBike(): boolean;
