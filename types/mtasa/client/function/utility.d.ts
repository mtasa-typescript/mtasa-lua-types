 ...
 * going from right to left, or read in horizontal rows from left to right, as for the
 * japanese (japan) locale.
 * |-
 * | <code>ttb-ltr</code> || read vertically from top to bottom with columns going from left
