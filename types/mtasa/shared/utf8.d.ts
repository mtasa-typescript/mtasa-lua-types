...
export namespace utf8 {
     ...
     * otherwise.
     */
    function byte(input: string, i?: number, j?: number): LuaMultiReturn<number[]>;
     ...
     */
    function charpos(input: string, charpos?: number, offset?: number): LuaMultiReturn<[number, number]>;
     ...
     */
    function find(input: string, pattern: string, startpos?: number, plain?: boolean): LuaMultiReturn<[number, number]>;
     ...
     * substitutions made.
     */
    function gsub(input: string, pattern: string, replace: string, match_limit?: number): string;
     ...
     */
    function insert(input: string, insert_pos?: number, substring?: string): string;
     ...
     */
    function match(input: string, pattern: string, index?: number): LuaMultiReturn<string[]>;
     ...
     */
    function next(input: string, charpos?: number, offset?: number): LuaMultiReturn<[number, number]>;
     ...
     */
    function width(int: string, ambi_is_double?: boolean, default_width?: number): number;
