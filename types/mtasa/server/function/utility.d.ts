 ...
 * by https://wiki.multitheftauto.com/wiki/decodestring decodestring. if a callback was
 * provided, true is returned immediately, and the iv is passed as an argument to the
 * callback.
 * @noSelf
 */
 ...
 * @noSelf
 */
export declare function getNetworkStats(
    thePlayer?: Element
): LuaTable;
 ...
 * @see {@link https://wiki.multitheftauto.com/wiki/GetServerConfigSetting Wiki, getServerConfigSetting }
 ...
 * @noSelf
 */
export declare function getServerConfigSetting(
    name: string
): string;
 ...
 * @see {@link https://wiki.multitheftauto.com/wiki/SetServerConfigSetting Wiki, setServerConfigSetting }
