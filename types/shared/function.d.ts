...
declare module 'mtasa/shared/functions' {
     ...
     * @return * For players/peds: A GTASA player model (skin) ID. See [[Character Skins]].
     * @return * For vehicles: The [[Vehicle IDs|vehicle ID]] of the vehicle.
     * @return * For objects: An [[int]] specifying the model id.
     */
     ...
     * @return The returned values are expressed in GTA units per 1/50th of a second[http://forum.mtasa.com/viewtopic.php?f=91&t=31225]. A GTA Unit is equal to one metre[http://gta.wikia.com/Unit#GTA3.2C_GTAVC_.26_GTASA].
     */
     ...
     * @return Returns ''true'' if the specified element is attached to another element, ''false'' if it is not attached or ''nil'' if an improper argument was passed.
     */
     ...
     * @return Also returns false if '''theElement''' is a player and it's not alive.
     */
     ...
     * @return * Returns '''true''' if the event was triggered successfully, and ''was not'' cancelled using [[cancelEvent]].
     * @return * Returns '''false''' if the event was triggered successfully, and ''was'' cancelled using [[cancelEvent]].
     */
     ...
     * @return * '''"none"''': No icon
     * @return * '''"arrow"''': Arrow icon
     * @return * '''"finish"''': Finish (end-race) icon
     */
     ...
     * @return {{Marker_types}}
     * @return If an invalid marker is specified, ''false'' is returned.
     */
     ...
     * @return ** '''2:''' Rear-left
     * @return ** '''3:''' Rear-right
     * @return Returns ''false'' if the ped is on foot, or the ped doesn't exist.
     */
     ...
     * @return This is only effective on physical GTA elements, namely:
     * @return * Players
     * @return * Peds
     * @return * Vehicles
     * @return * Objects
     ...
     * @return It should be noted that if a ped runs out of ammo for a weapon, it will still return the ID of that weapon in the slot (even if it appears as if the ped does not have a weapon at all), though [[getPedTotalAmmo]] will return '''0'''.  Therefore, [[getPedTotalAmmo]] should be used in conjunction with [[getPedWeapon]] in order to check if a ped has a weapon.
     */
     ...
     * @return *'''0:''' Health pickup
     * @return *'''1:''' Armour pickup
     * @return *'''2:''' Weapon pickup
     * @return *'''3:''' Custom Pickup
     */
     ...
     * @return <!-- Make this descriptive. Explain what cases will return false. If you're unsure, add a tag to it so we can check -->
     * @return Returns ''true'' if the player's name tag is being shown, ''false'' otherwise.
     */
     ...
     * @return Returns a '''''request''''' value which can be used with [[GetRemoteRequestInfo|getRemoteRequestInfo]] or [[AbortRemoteRequest|abortRemoteRequest]]
     * @return }}
     */
     ...
     * @return The state can be one of:
     * @return *'''loaded'''
     * @return *'''running'''
     * @return {{New feature|3|1.0|
     * @return *'''starting'''
     * @return *'''stopping'''
     * @return *'''failed to load''' - Use [[getResourceLoadFailureReason]] to find out why it failed.
     * @return }}
     */
     ...
     * @return The table contains:
     * @return *'''bytesReceived:''' A number specifying the amount of data received so far. Zero means the download is queued
     * @return *'''bytesTotal:''' A number specifying the final download size. Will be zero if the remote HTTP server has not set the 'Content-Length' header
     * @return *'''currentAttempt:''' A number specifying the current connection attempt
     * @return *'''type:''' A string specifying either "fetch" or "call"
     * @return *'''url:''' A string specifying the URL
     * @return *'''resource:''' The resource which started the request, or false if the resource has since been stopped/restarted
     * @return *'''queue:''' A string specifying the queue name
     * @return *'''method:''' A string specifying the HTTP method. e.g. "GET" or "POST"
     * @return *'''connectionAttempts:''' A number specifying max number connection attempts as declared in the fetchRemote call
     * @return *'''connectionTimeout:''' A number specifying connection attempt timeout as declared in the fetchRemote call
     * @return *'''postData:''' A string containing the request post data as declared in the fetchRemote call
     * @return *'''headers:''' A table containing the request HTTP headers as declared in the fetchRemote call
     */
     ...
     * @return On '''client''' this returns a boolean, whether the transfer box should be visible or not at the time of invocation.
     */
     ...
     */
    export function bitNot(var: number, ): number;
     ...
     */
    export function bitExtract(var: number, field: number, width?: number, ): number;
     ...
     */
    export function bitReplace(var: number, replaceValue: number, field: number, width: number, ): number;
     ...
     * @return '''Note:''' Indices of a JSON object such as "1": "cat" are being returned as [[string]], not as [[int]]eger.
     */
     ...
     * @return {| border="2" cellpadding="2" cellspacing="0" style="margin: 1em 1em 1em 0; background: #f9f9f9; border: 1px #aaa solid; border-collapse: collapse; font-size: 95%;"
     * @return |'''Member'''
     * @return |'''Meaning'''
     * @return |'''Range'''
     * @return |-
     ...
     * @return |-
     * @return |month
     * @return |months since January
     * @return |0-11
     * @return |-
     * @return |year
     * @return |years since 1900
     * @return |-
     * @return |weekday
     ...
     * @return |-
     * @return |yearday
     * @return |days since January 1
     * @return |0-365
     * @return |-
     * @return |isdst
     * @return |Daylight Saving Time flag
     * @return |-
     * @return |timestamp
     * @return |seconds since 1970 (Ignoring set timezone)
     * @return |
     * @return |}
     * @return ''* second'' is generally 0-59. Extra range to accommodate for leap seconds in certain systems.
     */
     ...
     * @return * Integer two represents the amount of times the timer has left to execute.
     * @return * Integer three represents the time interval of timer.
     * @return * Returns false if the timer doesn't exist or stopped running. Also, debugscript will say "Bad Argument @ 'getTimerDetails'". To prevent this, you can check if the timer exists with [[isTimer]]().
     */
     ...
     */
    export function inspect(var: string, options?: table, ): string;
     ...
     * @return As mentioned before, interpolateBetween can be used on 2D vectors or scalars in which case only some (x, y or just x) of the returned values are to be used (cf. alpha interpolation in marker example or size interpolation in window example).
     */
     ...
     * @return {{note|Unicode characters work but when combined with others do not. E.g: #split("a€cb†", "€") returns 3 but #split("a€cb", "€") returns 2.
     * @return }}
     * @return {{note|You can't use same char twice as a separator. Eg.:  ||, ||| are the same as |.
     * @return }}
     */
     ...
     * @return *Returns 4 [[int|ints]] (if bRGB is ''false'') indicating the color ids of each of the 4 vehicle colors.
     * @return *Returns ''false'' if the vehicle doesn't exist.
     * @return Valid color ids if bRGB is set to false:
     ...
     * @return * '''0:''' Shut, intact (also returned if the door does not exist)
     * @return * '''1:''' Ajar, intact
     * @return * '''2:''' Shut, damaged
     * @return * '''3:''' Ajar, damaged
     * @return * '''4:''' Missing
     */
     ...
     * @return Returns ''nil'' if the vehicle has no landing gear, or is invalid.
     */
     ...
     * @return If you use this function on vehicles with shared names, such as "police", it will return the earliest occurrence of that vehicle's ID.
     */
     ...
     * @return Returns ''false'' if an invalid vehicle was passed or if the vehicle has no seats (like a trailer)
     * @return <div style='font-weight: bold;background:blue;color:white;padding:2px; padding-left:8px;'>COUNTING PLAYERS IN A VEHICLE</div>
     * @return <div style='border: 2px solid blue;padding: 5px;'>Don't use an ipairs loop with the table returned by this function. It will skip the driver, as ipairs starts at 1 and the driver seat is ID 0. And if there's an empty seat, ipairs will stop looping. You should use a pairs loop instead.
     * @return <syntaxhighlight lang="lua">
     * @return local counter = 0
     * @return for seat, player in pairs(getVehicleOccupants(pseudoVehicle)) do
     * @return     counter = counter + 1
     * @return end
     * @return outputDebugString("Players in your vehicle: ".. counter)
     ...
     * @return * '''0''': The first paintjob
     * @return * '''1''': The second paintjob
     * @return * '''2''': The third paintjob
     * @return * '''3''': Default paintjob (no paintjob)
     * @return {{Note|Always returns 3 if paintjobs are not supported for the vehicle.}}
     */
     ...
     * @return <syntaxhighlight lang="lua">
     * @return [int]   SirenParams.SirenCount
     * @return [int]   SirenParams.SirenType
     * @return [table] SirenParams.Flags
     * @return  [bool] SirenParams.Flags["360"]
     * @return  [bool] SirenParams.Flags.DoLOSCheck
     * @return  [bool] SirenParams.Flags.UseRandomiser
     * @return  [bool] SirenParams.Flags.Silent
     * @return </syntaxhighlight>
     */
     ...
     * @return <syntaxhighlight lang="lua">
     * @return [float]   SirenData[sirenPoint].x
     * @return [float]   SirenData[sirenPoint].y
     * @return [float]   SirenData[sirenPoint].z
     * @return [int]     SirenData[sirenPoint].Red
     * @return [int]     SirenData[sirenPoint].Green
     * @return [int]     SirenData[sirenPoint].Blue
     * @return [int]     SirenData[sirenPoint].Alpha
     * @return [int]     SirenData[sirenPoint].Min_Alpha
     * @return </syntaxhighlight>
     */
     ...
     * @return * ''false'' if it isn't being towed.
     */
     ...
     * @return Possible strings returned:
     * @return {{VehicleTypes}}
     */
     ...
     * @return On success:
     * @return * '''int''': An integer for the first vehicle variant see [[Vehicle variants]]
     * @return * '''int''': An integer for the second vehicle variant see [[Vehicle variants]]
     * @return On failure:
     * @return * '''bool''': False because the specified vehicle didn't exist
     */
     ...
     * @return On success:
     * @return * '''bool''': Returns true as the vehicle variants were successfully set.
     * @return On failure:
     * @return * '''bool''': False because the specified vehicle didn't exist or specified variants were invalid.
     */
     ...
     * @return On success:
     * @return '''int:''' The weapon property
     * @return On failure:
     * @return '''bool:''' False if the passed arguments were invalid
     */
     ...
     * @return On success:
     * @return '''bool:''' Returns true if the weapon property was successfully set
     * @return On failure:
     * @return '''bool:''' Returns false if the weapon property was unable to be set
     */
     ...
     * @return *'''velocityY''': The velocity on the y-coordinate or nil if the wind velocity is default.
     * @return *'''velocityZ''': The velocity on the z-coordinate or nil if the wind velocity is default.
     */
     ...
     * @return The normal game speed is '1'.
     */
     ...
     * @return {{New items|3.0152|1.5|
     * @return Print error if something wrong with xml.
     * @return |7485}}
     */
